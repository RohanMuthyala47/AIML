...
model = Sequential([
    ...
    Dropout(0.5),
    Dense(len(new_training_images.class_indices), activation='softmax')  # Output layer with number of classes
])
...
new_testing_images.reset()  # Reset generator before evaluation

training_Loss, training_accuracy = model.evaluate(new_testing_images, verbose=1)
